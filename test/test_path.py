...
class TestPathTools(unittest.TestCase):
    ...
    def test_path_area(self):
        ...
        self.assertAlmostEqual(p.area(), 6966.71488795)

        p = Path()
        p.append(Line(start=(30.8775301394+123.285948504j), end=(117.198+253.168061914j)))
        p.append(Line(start=(117.198+253.168061914j), end=(117.198+170.495502987j)))
        p.append(Line(start=(117.198+170.495502987j), end=(30.8775301394+123.285948504j)))
        self.assertAlmostEqual(p.area(), -13109.6952335)

        p = Path()
        p.append(Arc(start=(12.7-73.613j), radius=(12.7+12.7j), rotation=0.0, large_arc=False, sweep=False, end=-60.913j))
        p.append(Line(start=-60.913j, end=74.6j))
        p.append(Arc(start=74.6j, radius=(25.4+25.4j), rotation=0.0, large_arc=False, sweep=False, end=(25.4+100j)))
        p.append(Line(start=(25.4+100j), end=(91.034+100j)))
        p.append(Arc(start=(91.034+100j), radius=(50.8+50.8j), rotation=0.0, large_arc=False, sweep=False, end=(141.834+49.2j)))
        p.append(Line(start=(141.834+49.2j), end=(141.834+27.987j)))
        p.append(Arc(start=(141.834+27.987j), radius=(101.6+101.6j), rotation=0.0, large_arc=False, sweep=False, end=(40.234-73.613j)))
        p.append(Line(start=(40.234-73.613j), end=(12.7-73.613j)))
        self.assertAlmostEqual(p.area(), -21682.1057449)

        p = Path()
        p.append(Arc(start=(5+35j), radius=(5+5j), rotation=0.0, large_arc=False, sweep=False, end=(10+40j)))
        p.append(Line(start=(10+40j), end=(35+40j)))
        p.append(Arc(start=(35+40j), radius=(5+5j), rotation=0.0, large_arc=False, sweep=False, end=(40+35j)))
        p.append(Line(start=(40+35j), end=(40+10j)))
        p.append(Arc(start=(40+10j), radius=(5+5j), rotation=0.0, large_arc=False, sweep=False, end=(35+5j)))
        p.append(Line(start=(35+5j), end=(10+5j)))
        p.append(Arc(start=(10+5j), radius=(5+5j), rotation=0.0, large_arc=False, sweep=False, end=(5+10j)))
        p.append(Line(start=(5+10j), end=(5+35j)))
        self.assertAlmostEqual(p.area(), -1203.53978404)

        p = Path()
        p.append(Line(start=(71.226+62.829j), end=(20.663-11.784j)))
        p.append(Arc(start=(20.663-11.784j), radius=(12.7+12.7j), rotation=0.0, large_arc=False, sweep=True, end=(7.963+0.916j)))
        p.append(Arc(start=(7.963+0.916j), radius=(12.7+12.7j), rotation=0.0, large_arc=False, sweep=True, end=(-4.737-11.784j)))
        p.append(Line(start=(-4.737-11.784j), end=(-50.523+49.364j)))
        p.append(Arc(start=(-50.523+49.364j), radius=(25.4+25.4j), rotation=0.0, large_arc=False, sweep=True, end=(-37.998+68.152j)))
        p.append(Arc(start=(-37.998+68.152j), radius=(25.4+25.4j), rotation=0.0, large_arc=False, sweep=True, end=(-45.383+89.49j)))
        p.append(Line(start=(-45.383+89.49j), end=(-8.238+165.119j)))
        p.append(Arc(start=(-8.238+165.119j), radius=(16.891+16.891j), rotation=0.0, large_arc=False, sweep=True, end=(-1.84+146.586j)))
        p.append(Arc(start=(-1.84+146.586j), radius=(16.891+16.891j), rotation=0.0, large_arc=False, sweep=True, end=(17.766+146.586j)))
        p.append(Arc(start=(17.766+146.586j), radius=(16.891+16.891j), rotation=0.0, large_arc=False, sweep=True, end=(24.164+165.119j)))
        p.append(Line(start=(24.164+165.119j), end=(71.945+78.757j)))
        p.append(Arc(start=(71.945+78.757j), radius=(15.24+15.24j), rotation=0.0, large_arc=False, sweep=True, end=(55.134+86.217j)))
        p.append(Arc(start=(55.134+86.217j), radius=(15.24+15.24j), rotation=0.0, large_arc=False, sweep=True, end=(43.386+72.066j)))
        p.append(Arc(start=(43.386+72.066j), radius=(15.24+15.24j), rotation=0.0, large_arc=False, sweep=True, end=(53.811+56.914j)))
        p.append(Arc(start=(53.811+56.914j), radius=(15.24+15.24j), rotation=0.0, large_arc=False, sweep=True, end=(71.226+62.829j)))
        self.assertAlmostEqual(p.area(), -12510.0458852)

        p = Path()
        p.append(Arc(start=(-15-3.10234660665e-12j), radius=(15+15j), rotation=0.0, large_arc=True, sweep=True, end=(15+6.20469321331e-12j)))
        p.append(Line(start=(15+6.20469321331e-12j), end=(15+275j)))
        p.append(Arc(start=(15+275j), radius=(15+15j), rotation=0.0, large_arc=True, sweep=True, end=(-15+275j)))
        p.append(Line(start=(-15+275j), end=(-15-3.10234660665e-12j)))
        self.assertAlmostEqual(p.area(), 8956.85718432)

        # Circle, radius 3.5, area = pi*r^2 = 38.48451000647496
        p = Path()
        p.append(Arc(start=(-3.5+0j), radius=(3.5+3.5j), rotation=0.0, large_arc=True, sweep=False, end=(3.5+0j)))
        p.append(Arc(start=(3.5+0j), radius=(3.5+3.5j), rotation=0.0, large_arc=True, sweep=False, end=(-3.5+0j)))
        self.assertAlmostEqual(p.area(), -38.48451000647496)
        ...
        p = Path()
        p.append(Arc(start=(9.763+15.795j), radius=(4.762+4.762j), rotation=0.0, large_arc=False, sweep=False, end=(5+20.557j)))
        p.append(Line(start=(5+20.557j), end=(5+35.162j)))
        p.append(Arc(start=(5+35.162j), radius=(4.763+4.763j), rotation=0.0, large_arc=False, sweep=False, end=(9.763+39.925j)))
        p.append(Line(start=(9.763+39.925j), end=(96.542+39.925j)))
        p.append(Line(start=(96.542+39.925j), end=(96.542+50.72j)))
        p.append(Line(start=(96.542+50.72j), end=(136.648+50.72j)))
        p.append(Line(start=(136.648+50.72j), end=(136.648+5j)))
        p.append(Line(start=(136.648+5j), end=(96.542+5j)))
        p.append(Line(start=(96.542+5j), end=(96.542+15.795j)))
        p.append(Line(start=(96.542+15.795j), end=(9.763+15.795j)))
        self.assertAlmostEqual(p.area(), -4032.81982286)

        p = Path()
	p.append(Arc(start=(48.812+32.919j), radius=(21.838+21.838j), rotation=0.0, large_arc=False, sweep=False, end=(25.557+15.484j)))
	p.append(Arc(start=(25.557+15.484j), radius=(21.838+21.838j), rotation=0.0, large_arc=False, sweep=False, end=(5.579+36.594j)))
	p.append(Arc(start=(5.579+36.594j), radius=(21.838+21.838j), rotation=0.0, large_arc=False, sweep=False, end=(24.268+58.854j)))
	p.append(Arc(start=(24.268+58.854j), radius=(21.838+21.838j), rotation=0.0, large_arc=False, sweep=False, end=(48.517+42.831j)))
	p.append(Arc(start=(48.517+42.831j), radius=(11.724+11.724j), rotation=0.0, large_arc=False, sweep=False, end=(51.36+54.282j)))
	p.append(Arc(start=(51.36+54.282j), radius=(11.724+11.724j), rotation=0.0, large_arc=False, sweep=False, end=(62.722+57.463j)))
	p.append(Arc(start=(62.722+57.463j), radius=(11.724+11.724j), rotation=0.0, large_arc=False, sweep=False, end=(71.096+49.151j)))
	p.append(Arc(start=(71.096+49.151j), radius=(17.62+17.62j), rotation=0.0, large_arc=False, sweep=False, end=(80.741+64.335j)))
	p.append(Arc(start=(80.741+64.335j), radius=(17.62+17.62j), rotation=0.0, large_arc=False, sweep=False, end=(98.69+63.138j)))
	p.append(Arc(start=(98.69+63.138j), radius=(17.62+17.62j), rotation=0.0, large_arc=False, sweep=False, end=(106.234+46.808j)))
	p.append(Arc(start=(106.234+46.808j), radius=(24.4+24.4j), rotation=0.0, large_arc=False, sweep=False, end=(133.001+64.526j)))
	p.append(Arc(start=(133.001+64.526j), radius=(24.4+24.4j), rotation=0.0, large_arc=False, sweep=False, end=(154.162+40.388j)))
	p.append(Arc(start=(154.162+40.388j), radius=(24.4+24.4j), rotation=0.0, large_arc=False, sweep=False, end=(133.093+16.171j)))
	p.append(Arc(start=(133.093+16.171j), radius=(24.4+24.4j), rotation=0.0, large_arc=False, sweep=False, end=(106.259+33.786j)))
	p.append(Line(start=(106.259+33.786j), end=(79.765+5.4j)))
	p.append(Line(start=(79.765+5.4j), end=(79.365+27j)))
	p.append(Line(start=(79.365+27j), end=(65.365+25.6j)))
	p.append(Line(start=(65.365+25.6j), end=(66.365+5j)))
	p.append(Line(start=(66.365+5j), end=(48.812+32.919j)))
        self.assertAlmostEqual(p.area(), -5589.10478512)

	p = Path()
	p.append(Arc(start=(25.4+91.427j), radius=(4.762+4.762j), rotation=0.0, large_arc=False, sweep=False, end=(30.163+96.19j)))
	p.append(Line(start=(30.163+96.19j), end=(139.167+96.19j)))
	p.append(Line(start=(139.167+96.19j), end=(139.167+77.521j)))
	p.append(Line(start=(139.167+77.521j), end=(12.281+77.521j)))
	p.append(Arc(start=(12.281+77.521j), radius=(4.762+4.762j), rotation=0.0, large_arc=False, sweep=False, end=(7.518+82.284j)))
	p.append(Line(start=(7.518+82.284j), end=(7.518+86.347j)))
	p.append(Arc(start=(7.518+86.347j), radius=(4.762+4.762j), rotation=0.0, large_arc=False, sweep=False, end=(12.281+91.11j)))
	p.append(Line(start=(12.281+91.11j), end=(25.4+91.11j)))
	p.append(Line(start=(25.4+91.11j), end=(25.4+91.427j)))
        self.assertAlmostEqual(p.area(), -2352.31525366)

	p = Path()
	p.append(Arc(start=(11.773+71.679j), radius=(4.762+4.762j), rotation=0.0, large_arc=False, sweep=False, end=(7.01+76.442j)))
	p.append(Line(start=(7.01+76.442j), end=(7.01+91.808j)))
	p.append(Arc(start=(7.01+91.808j), radius=(4.762+4.762j), rotation=0.0, large_arc=False, sweep=False, end=(11.773+96.571j)))
	p.append(Line(start=(11.773+96.571j), end=(99.06+96.571j)))
	p.append(Line(start=(99.06+96.571j), end=(99.06+107.366j)))
	p.append(Line(start=(99.06+107.366j), end=(139.167+107.366j)))
	p.append(Line(start=(139.167+107.366j), end=(139.167+60.884j)))
	p.append(Line(start=(139.167+60.884j), end=(99.06+60.884j)))
	p.append(Line(start=(99.06+60.884j), end=(99.06+71.679j)))
	p.append(Line(start=(99.06+71.679j), end=(11.773+71.679j)))
        self.assertAlmostEqual(p.area(), -4145.82926244)

	p = Path()
	p.append(Line(start=(2.921+98.999j), end=(14.326+98.999j)))
	p.append(Arc(start=(14.326+98.999j), radius=(4.763+4.763j), rotation=0.0, large_arc=False, sweep=True, end=(12.484+95.237j)))
	p.append(Line(start=(12.484+95.237j), end=(12.484+94.933j)))
	p.append(Line(start=(12.484+94.933j), end=(4.762+94.933j)))
	p.append(Line(start=(4.762+94.933j), end=(4.762+95.237j)))
